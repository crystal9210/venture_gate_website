...
export const AnimatedLogo = forwardRef<HTMLDivElement>((props, ref) => (
    ...
    <div
        className="w-124 h-32 flex flex-start items-center justify-center max-[414px]:w-[60vw] max-[414px]:h-auto max-[414px]:!h-auto max-[414px]:my-0 max-[414px]:py-0 max-[414px]:gap-0"
